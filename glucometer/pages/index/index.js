  ...
  getBLEDeviceCharacteristics() {
    ...
    wx.getBLEDeviceCharacteristics({
      ...
      success(res) {
        ...
        // that.static.read_charuuid = '00001002-0000-1000-8000-00805F9B34FB'
        // 链接百捷设配 监听特征值的变化()
    ...
    wx.notifyBLECharacteristicValueChange({
      ...
      success(res) {
        ...
        wx.onBLECharacteristicValueChange(function (res) {
          ...
          // 2450434c61000000090000001301111514910028   24 50 43 4C 41 00 00 00 09 00 00 00 0F 08 11 0B 33 7D 01 0D 
          // 7D 01: Value = 0X017D = 381 mg/dL = 21.2mmol/L
